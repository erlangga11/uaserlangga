...
$upload_path='https://objectstorage.ap-tokyo-1.oraclecloud.com/p/JHq6kthkv3pXiM4F0OURmzhUeQz0WrJ4wpgh0XGIM0xxq9fJcliqlZikRBi5FD_p/n/nrvcevruh6qe/b/bucketUTS/o/';
...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
	if($picture_size<=50000000)
		...
		move_uploaded_file($_FILES['picture']['tmp_name'],$upload_path.$picture_tmp_name.'_'.$pic_name);		
          ...
          <div class="col-md-5">
            <div class="card">
              ...
              <div class="card-footer">
                  <button type="submit" id="btn_save" name="btn_save" required class="btn btn-fill btn-primary">Simpan Product</button>
              </div>
            </div>
          </div>
